...
/**
 * JUnit Test of ArticlePriceDescComparator.
 *
 * @author Mischa Gruber
 */
public class ArticlePriceDescComparatorTest {

    @Test
    public void testSorting() {
        List<ArticleDTO> articleDTOs = new ArrayList<>();
        ArticleDTO article1 = new ArticleDTO(1);
        article1.setPrice(new Double(5));
        ArticleDTO article2 = new ArticleDTO(2);
        article2.setPrice(new Double(10));
        articleDTOs.add(article1);
        articleDTOs.add(article2);

        Comparator<ArticleDTO> comparator = new ArticlePriceDescComparator();
